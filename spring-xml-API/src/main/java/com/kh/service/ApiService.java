...
public class ApiService {
	...
	// Value 어노테이션을 이용해서 application.properties 에 작성된
	...
	public String getAirData() throws Exception {
		...
		// 남의 주소에서 남이 지정한 형식을 가져와야하기 때문에 한줄씩 읽어서 모두 실시간으로 가져오기
